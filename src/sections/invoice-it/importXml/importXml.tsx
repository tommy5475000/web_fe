...
import { Button, Select, MenuItem, TextField, InputLabel, Typography, DialogTitle, DialogActions, DialogContent } from "@mui/material";
...
import type { ImportXmlProps } from "./type"; 
        ...
        if (selectedFile) {
            ...
            reader.onload = (event) => {
                ...
                const invoice = {
                    ...
                    noiDung, // sẽ gán lại từ state khi Upload
                    loaiHinh,
